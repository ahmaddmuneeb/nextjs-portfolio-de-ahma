...
import { calculateTimePeriod } from '@/lib/utils/generateTimeDiff';
      ...
      <div className="space-y-2 pb-4 pt-6 md:space-y-5">
        ...
        <p className="space-y-4 text-zinc-500 dark:text-slate-300">
          <p className="my-4 leading-loose">
            ...
            , I am passionate about digital, new technologies and Mobile App development and design
            projects. During my professional experiences, I was able to discover many sectors of
            activity : Innovation at{' '}
            <a
              className="focusable rounded-sm font-medium text-zinc-800 underline decoration-red-800 decoration-2 underline-offset-2 transition duration-100 hover:text-red-800 hover:decoration-blue-800/30 focus:text-red-500 focus:ring-red-500/40 dark:text-white dark:decoration-sky-400 dark:hover:text-sky-400 dark:hover:decoration-sky-400/30 dark:focus:text-sky-400 dark:focus:ring-sky-400/40"
            ...
            as a Software Engineer. And then at{' '}
            <a
              ...
              target="_blank"
            >
              The Webie Storms (TWS)
            </a>{' '}
            as a ReactJs Developer. And then promoted to Lead Frontend Engineer at{' '}
            <a
              ...
              target="_blank"
            >
              Blackstack Software, Inc.
            </a>
            . Now I'm working as Software Engineer at{' '}
            <a
              className="focusable rounded-sm font-medium text-zinc-800 underline decoration-blue-500 decoration-2 underline-offset-2 transition duration-100 hover:text-blue-500 hover:decoration-blue-500/30 focus:text-violet-500 focus:ring-violet-500/40 dark:text-white dark:decoration-violet-400 dark:hover:text-violet-400 dark:hover:decoration-violet-400/30 dark:focus:text-violet-400 dark:focus:ring-violet-400/40"
            ...
            in Telehealth application for seniors that is{' '}
            <a
            ...
            Besides that, I cofounded the tech agency agency{' '}
            <a
            ...
            , that I'm still working on. Versatile & curious in digital marketing, new tech stack,
            SAAS products. I am confident in several aspects such as Social Media, SEO, E-CRM &
            Content creation.{' '}
          </p>
        </p>
        <div className="mt-8 flex flex-wrap gap-4 text-center">
          <a
            ...
            href="https://www.linkedin.com/in/ahmaddmuneeb"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            ...
            href="https://github.com/ahmaddmuneeb"
            rel="noreferrer"
            target="_blank"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
          ...
          <a
            ...
            href="mailto:ahmaddmuneeb@gmail.com"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
              <path
                clipRule="evenodd"
          ...
          <a
            className="focusable flex flex-none cursor-pointer items-center justify-center gap-2 rounded-md bg-blue-500 px-2.5 py-2 font-medium text-white shadow-lg shadow-blue-500/10 transition selection:bg-white/30 hover:bg-blue-500/80 hover:shadow-blue-500/5 focus:ring-blue-500/40 dark:bg-blue-400 dark:text-zinc-900 dark:shadow-blue-400/10 dark:selection:bg-zinc-900/30 dark:hover:bg-blue-400/80 dark:hover:shadow-blue-400/5 dark:focus:ring-blue-400/40 sm:w-auto sm:px-3 sm:pl-2.5"
            href="https://twitter.com/ahmaddmuneeb"
            rel="noreferrer"
            target="_blank"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="content mt-12 sm:mt-24">
        ...
        <ul className="mt-8">
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            ...
            >
              <Image
                src="/static/images/workxp/vsss.png"
                alt="VSSS"
                width="50px"
                height="50px"
            ...
            <div className="flex min-w-0 flex-col justify-center">
              <p className="mb-1 flex items-center">
                ...
                <span className="ml-1.5 inline-block flex-none translate-y-px rounded bg-zinc-100 p-1 text-xs font-medium leading-none text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
                  ...
                  Present ({calculateTimePeriod('12, 2022', '')})
                </span>
              </p>
          ...
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            <a
              className="link focusable font-medium text-zinc-800 dark:text-white"
              href="https://markitech.ca/"
              rel="noreferrer"
              target="_blank"
            >
              <Image
                src="/static/images/workxp/mkt_logo.png"
                alt="mkt"
                width="50px"
                height="50px"
                className="rounded-md"
            ...
            <div className="flex min-w-0 flex-col justify-center">
              <p className="mb-1 flex items-center">
                ...
                <span className="ml-1.5 inline-block flex-none translate-y-px rounded bg-zinc-100 p-1 text-xs font-medium leading-none text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
                  Oct, 2022
                  <span className="text-zinc-350 dark:text-zinc-550 mx-0.5"> — </span>
                  Present ({calculateTimePeriod('10, 2022', '')})
                </span>
              </p>
              <p className="flex items-center truncate">
                <span className="flex-1 truncate text-zinc-500 dark:text-zinc-400">
                  Software Engineer (React Native | IOT Device Engineer)
                </span>
              </p>
            </div>
          </li>
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            ...
            >
              <Image
                src="/static/images/workxp/waab_logo.png"
                alt="WAAB"
                width="50px"
                height="50px"
                className="rounded-md"
            ...
            <div className="flex min-w-0 flex-col justify-center">
              <p className="mb-1 flex items-center">
                ...
                <span className="ml-1.5 inline-block flex-none translate-y-px rounded bg-zinc-100 p-1 text-xs font-medium leading-none text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
                  Sep, 2020
                  <span className="text-zinc-350 dark:text-zinc-550 mx-0.5"> — </span>
                  Oct, 2021 ({calculateTimePeriod('09, 2020', '10, 2021')})
                </span>
              </p>
              <p className="flex items-center truncate">
                <span className="flex-1 truncate text-zinc-500 dark:text-zinc-400">
            ...
            <div className="flex min-w-0 flex-col justify-center">
              <p className="mb-1 flex items-center">
                ...
                <span className="ml-1.5 inline-block flex-none translate-y-px rounded bg-zinc-100 p-1 text-xs font-medium leading-none text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
                  Sep, 2021
                  <span className="text-zinc-350 dark:text-zinc-550 mx-0.5"> — </span>
                  Present ({calculateTimePeriod('10, 2021', '')})
                </span>
              </p>
              <p className="flex items-center truncate">
                <span className="flex-1 truncate text-zinc-500 dark:text-zinc-400">
                  Software Engineer (React Native) | Teach Lead
                </span>
              </p>
            </div>
          </li>
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            <a
              className="link focusable font-medium text-zinc-800 dark:text-white"
              href="https://bkstack.com/"
              rel="noreferrer"
              target="_blank"
            >
              <Image
                src="/static/images/workxp/bks_logo.png"
                alt="Bkstack"
                width="50px"
                height="50px"
                className="rounded-md"
            ...
            <div className="flex min-w-0 flex-col justify-center">
              <p className="mb-1 flex items-center">
                ...
                <span className="ml-1.5 inline-block flex-none translate-y-px rounded bg-zinc-100 p-1 text-xs font-medium leading-none text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
                  Mar, 2022
                  <span className="text-zinc-350 dark:text-zinc-550 mx-0.5"> — </span>
                  Oct, 2022 ({calculateTimePeriod('03, 2022', '10, 2022')})
                </span>
              </p>
              <p className="flex items-center truncate">
                <span className="flex-1 truncate text-zinc-500 dark:text-zinc-400">
                  Software Engineer (Lead Frontend Engineer)
                </span>
              </p>
            </div>
          </li>
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            <a
              className="link focusable font-medium text-zinc-800 dark:text-white"
              href="https://www.thewebstorms.com/"
              rel="noreferrer"
              target="_blank"
            >
              <Image
                src="/static/images/workxp/tws_logo.png"
                alt="TWS"
                width="50px"
                height="50px"
                className="rounded-md"
            ...
            <div className="flex min-w-0 flex-col justify-center">
              <p className="mb-1 flex items-center">
                <span className="trfuncate font-semibold text-zinc-700 dark:text-zinc-100">
                  TWS
                </span>
                <span className="ml-1.5 inline-block flex-none translate-y-px rounded bg-zinc-100 p-1 text-xs font-medium leading-none text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
                  Oct, 2021
                  <span className="text-zinc-350 dark:text-zinc-550 mx-0.5"> — </span>
                  Mar, 2022 ({calculateTimePeriod('10, 2022', '')})
                </span>
              </p>
              <p className="flex items-center truncate">
                <span className="flex-1 truncate text-zinc-500 dark:text-zinc-400">
                  Software Engineer (ReactJS | Laravel)
                </span>
              </p>
            </div>
          </li>
